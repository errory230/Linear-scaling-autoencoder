...
example data: data/ftir.csv from https://www.nature.com/articles/s41598-017-18228-7

Usage:
    import train;
    train.run(data='data/ftir.csv', tolerance=3, plot_loss=True, vis_latent=True, vis_prediction=True)
or
    python train.py --data data/ftir.csv --tolerance 3 --plot_loss True --vis_latent True --vis_prediction True
'''
